...
describe('Request Logger Middleware', () => {
  ...
  const createMockReq = (path: string = '/api/v1/projects'): Partial<Request> => ({
    method: 'GET',
    path,
    originalUrl: path,
    ip: '127.0.0.1',
  ...
  describe('requestLogger', () => {
    ...
    it('should add requestId to request object', () => {
      const req = createMockReq('/api/v1/projects');
  ...
  describe('errorLogger', () => {
    ...
    it('should include request details in log', () => {
      const error = new Error('Test error');
      const req = { ...createMockReq('/api/v1/projects'), method: 'POST' };
